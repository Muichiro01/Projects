...
import random
while True:
    user_random=input("Enter rock,paper or scissors: ")
    possible_actions=["rock","paper","scissors"]
    computer_action=random.choice(possible_actions)
    print(f"\nYou choose {user_random}, computer chose {computer_action}\n")
    if user_random==computer_action:
        print("It is a tie")
    elif user_random=="rock":
        if computer_action=="scissors":
            print("You win")
        else:
            print("You lose")
    elif user_random=="paper":
        if computer_action=="rock":
            print("You win")
        else:
            print("You lose")    
    elif user_random=="scissors":
